...
class _writedriver_dummy(_SizableCircuit):
    ...
    def generate(self, subcircuit_filename, min_tran_width):
        ...
        self.transistor_names, self.wire_names = dummyarray_subcircuits.generate_writedriver_dummy_lp(subcircuit_filename, self.name)

        # Sizing according to Kosuke
        self.initial_transistor_sizes["inv_writedriver_dummy_1_nmos"] = 1 
        self.initial_transistor_sizes["inv_writedriver_dummy_1_pmos"] = 1.22
        self.initial_transistor_sizes["inv_writedriver_dummy_2_nmos"] = 1
        self.initial_transistor_sizes["inv_writedriver_dummy_2_pmos"] = 1.22
        self.initial_transistor_sizes["tgate_writedriver_dummy_3_nmos"] = 2.67
        self.initial_transistor_sizes["tgate_writedriver_dummy_3_pmos"] = 2
    ...
    def update_area(self, area_dict, width_dict):
        ...
        area = area_dict["inv_writedriver_dummy_1"]*2 + area_dict["inv_writedriver_dummy_2"] + area_dict["tgate_writedriver_dummy_3"]*4
        area_with_sram = area
        width = math.sqrt(area)
        width_with_sram = math.sqrt(area_with_sram)
        area_dict[self.name] = area
...
class _readcircuit_dummy(_SizableCircuit):
    ...
    def generate(self, subcircuit_filename, min_tran_width):
        ...
        self.transistor_names, self.wire_names = dummyarray_subcircuits.generate_readcircuit_dummy_lp(subcircuit_filename, self.name)

        # Sizing according to Kosuke
        self.initial_transistor_sizes["inv_readcircuit_dummy_1_nmos"] = 1 
        self.initial_transistor_sizes["inv_readcircuit_dummy_1_pmos"] = 1.22
        self.initial_transistor_sizes["inv_readcircuit_dummy_2_nmos"] = 1
        self.initial_transistor_sizes["inv_readcircuit_dummy_2_pmos"] = 1.22
        self.initial_transistor_sizes["inv_readcircuit_dummy_3_nmos"] = 2
        self.initial_transistor_sizes["inv_readcircuit_dummy_3_pmos"] = 2.44
    ...
    def update_area(self, area_dict, width_dict):
        ...
        area = area_dict["inv_readcircuit_dummy_1"]*2 + area_dict["inv_readcircuit_dummy_2"]*8 + area_dict["inv_readcircuit_dummy_3"]*2
        area_with_sram = area
        width = math.sqrt(area)
        width_with_sram = math.sqrt(area_with_sram)
        area_dict[self.name] = area
...
class _samp_dummy(_SizableCircuit):
    ...
    def generate(self, subcircuit_filename, min_tran_width):
        print "Generating sense amp for the dummy array" 
        self.transistor_names, self.wire_names = dummyarray_subcircuits.generate_samp_dummy_lp(subcircuit_filename, self.name)

        # Sizing according to Kosuke
        self.initial_transistor_sizes["inv_samp_dummy_1_nmos"] = 2 
        self.initial_transistor_sizes["inv_samp_dummy_1_pmos"] = 2.44
        #its not actually a PTRAN. Doing this only for area calculation:
        self.initial_transistor_sizes["ptran_samp_dummy_1_pmos"] = 5.555
        self.initial_transistor_sizes["ptran_samp_dummy_2_nmos"] = 2.222
        self.initial_transistor_sizes["ptran_samp_dummy_3_nmos"] = 20.0
        self.initial_transistor_sizes["ptran_samp_dummy_4_nmos"] = 5.555
    ...
    def update_area(self, area_dict, width_dict):
        ...
        area = area_dict["inv_samp_dummy_1"]*2 + area_dict["ptran_samp_dummy_1"]*2 +  area_dict["ptran_samp_dummy_2"]*2 + area_dict["ptran_samp_dummy_3"]*2 +  area_dict["ptran_samp_dummy_4"]
        area_with_sram = area
        width = math.sqrt(area)
        width_with_sram = math.sqrt(area_with_sram)
        area_dict[self.name] = area
...
class _fulladder_dummy(_SizableCircuit):
    ...
    def generate(self, subcircuit_filename, min_tran_width):
        ...
        #self.transistor_names, self.wire_names = dummyarray_subcircuits.generate_fulladder_dummy_lp(subcircuit_filename, self.name)
        self.transistor_names, self.wire_names = dummyarray_subcircuits.generate_fulladder_dummy(subcircuit_filename, self.name, self.numberofsramsinrow)

        # Sizing according to Kosuke
        self.initial_transistor_sizes["tgate_fulladder_dummy_1_nmos"] = 1
        self.initial_transistor_sizes["tgate_fulladder_dummy_1_pmos"] = 1
        self.initial_transistor_sizes["inv_fulladder_dummy_2_nmos"] = 1.44
        self.initial_transistor_sizes["inv_fulladder_dummy_2_pmos"] = 1.77
        self.initial_transistor_sizes["tgate_fulladder_dummy_3_nmos"] = 1
        self.initial_transistor_sizes["tgate_fulladder_dummy_3_pmos"] = 1.22
        self.initial_transistor_sizes["inv_fulladder_dummy_4_nmos"] = 1
        self.initial_transistor_sizes["inv_fulladder_dummy_4_pmos"] = 1.22
    ...
    def update_area(self, area_dict, width_dict):
        ...
        area = area_dict["tgate_fulladder_dummy_1"]*4 + area_dict["inv_fulladder_dummy_2"] + \
                area_dict["tgate_fulladder_dummy_3"]*6 + area_dict["inv_fulladder_dummy_4"]
        area_with_sram = area
        width = math.sqrt(area)
        width_with_sram = math.sqrt(area_with_sram)
        area_dict[self.name] = area
...
class _manchester4_dummy(_SizableCircuit):
    ...
    def generate(self, subcircuit_filename, min_tran_width):
        ...
        self.transistor_names, self.wire_names = dummyarray_subcircuits.generate_manchester4_dummy(subcircuit_filename, self.name, self.numberofsramsinrow)

        # Sizing according to Kosuke
        self.initial_transistor_sizes["ptran_manchester4_dummy_0_pmos"] = 1 
        self.initial_transistor_sizes["ptran_manchester4_dummy_1_nmos"] = 4
        self.initial_transistor_sizes["inv_manchester4_dummy_2_nmos"] = 1
        self.initial_transistor_sizes["inv_manchester4_dummy_2_pmos"] = 1.22
        self.initial_transistor_sizes["tgate_manchester4_dummy_3_nmos"] = 1
        self.initial_transistor_sizes["tgate_manchester4_dummy_3_pmos"] = 1.22
        self.initial_transistor_sizes["inv_manchester4_dummy_4_nmos"] = 1.44
        self.initial_transistor_sizes["inv_manchester4_dummy_4_pmos"] = 1.75
        self.initial_transistor_sizes["ptran_manchester4_dummy_5_nmos"] = 8
        self.initial_transistor_sizes["ptran_manchester4_dummy_6_nmos"] = 4
    ...
    def update_area(self, area_dict, width_dict):
        ...
        area = area_dict["ptran_manchester4_dummy_0"]*5 + area_dict["ptran_manchester4_dummy_1"]*2 + area_dict["inv_manchester4_dummy_2"]*26 + \
                area_dict["tgate_manchester4_dummy_3"]*16 + area_dict["inv_manchester4_dummy_4"]*7 + \
                area_dict["ptran_manchester4_dummy_5"]*6 + area_dict["ptran_manchester4_dummy_6"]*8
...
class _lookahead4_dummy(_SizableCircuit):
    ...
    def generate(self, subcircuit_filename, min_tran_width):
        ...
        self.transistor_names, self.wire_names = dummyarray_subcircuits.generate_lookahead4_dummy(subcircuit_filename, self.name, self.numberofsramsinrow)

        # Sizing according to Kosuke
        self.initial_transistor_sizes["inv_lookahead4_dummy_1_nmos"] = 8 
        self.initial_transistor_sizes["inv_lookahead4_dummy_1_pmos"] = 8
        self.initial_transistor_sizes["inv_lookahead4_dummy_2_nmos"] = 4
        self.initial_transistor_sizes["inv_lookahead4_dummy_2_pmos"] = 4
        self.initial_transistor_sizes["inv_lookahead4_dummy_3_nmos"] = 2
        self.initial_transistor_sizes["inv_lookahead4_dummy_3_pmos"] = 2
        self.initial_transistor_sizes["inv_lookahead4_dummy_4_nmos"] = 1
        self.initial_transistor_sizes["inv_lookahead4_dummy_4_pmos"] = 1.22
        self.initial_transistor_sizes["tgate_lookahead4_dummy_5_nmos"] = 1
        self.initial_transistor_sizes["tgate_lookahead4_dummy_5_pmos"] = 1.22
        self.initial_transistor_sizes["inv_lookahead4_dummy_6_nmos"] = 1.44
        self.initial_transistor_sizes["inv_lookahead4_dummy_6_pmos"] = 1.78
    ...
    def update_area(self, area_dict, width_dict):
        ...
        area = area_dict["inv_lookahead4_dummy_1"]*5 + area_dict["inv_lookahead4_dummy_2"]*4 + \
                area_dict["inv_lookahead4_dummy_3"]*1 + area_dict["inv_lookahead4_dummy_4"]*22 + \
                area_dict["tgate_lookahead4_dummy_5"]*22 + area_dict["inv_lookahead4_dummy_6"]*4
...
class _mux3_dummy(_SizableCircuit):
    ...
    def generate(self, subcircuit_filename, min_tran_width):
        ...
        self.transistor_names, self.wire_names = dummyarray_subcircuits.generate_mux3_dummy_lp(subcircuit_filename, self.name)

        self.initial_transistor_sizes["tgate_mux3_dummy_1_nmos"] = 1 
        self.initial_transistor_sizes["tgate_mux3_dummy_1_pmos"] = 2
    ...
    def update_area(self, area_dict, width_dict):
        ...
        area = area_dict["tgate_mux3_dummy_1"]*3
        area_with_sram = area
        width = math.sqrt(area)
        width_with_sram = math.sqrt(area_with_sram)
        area_dict[self.name] = area
...
class _mux2_dummy(_SizableCircuit):
    ...
    def generate(self, subcircuit_filename, min_tran_width):
        ...
        self.transistor_names, self.wire_names = dummyarray_subcircuits.generate_mux2_dummy_lp(subcircuit_filename, self.name)

        self.initial_transistor_sizes["tgate_mux2_dummy_1_nmos"] = 1 
        self.initial_transistor_sizes["tgate_mux2_dummy_1_pmos"] = 2
    ...
    def update_area(self, area_dict, width_dict):
        ...
        area = area_dict["tgate_mux2_dummy_1"]*2
        area_with_sram = area
        width = math.sqrt(area)
        width_with_sram = math.sqrt(area_with_sram)
        area_dict[self.name] = area
...
class _samp(_SizableCircuit):
    ...
    def generate(self, subcircuit_filename, min_tran_width):
        ...
        self.initial_transistor_sizes["inv_samp_output_1_nmos"] = 2
        self.initial_transistor_sizes["inv_samp_output_1_pmos"] = 2.44
        #its not actually a PTRAN. Doing this only for area calculation:
    ...
    def update_area(self, area_dict, width_dict):
        ...
        # Modified by Yuzong Chen, there should be 2 inverters instead of 1 in samp
        area = area_dict["inv_samp_output_1"]*2 + area_dict["ptran_samp_output_1"]*2 +  area_dict["ptran_samp_output_2"]*2 + area_dict["ptran_samp_output_3"]*2 +  area_dict["ptran_samp_output_1"]
        area_with_sram = area
        width = math.sqrt(area)
        width_with_sram = math.sqrt(area_with_sram)
        area_dict[self.name] = area
...
class _prechargeandeq_dummy(_SizableCircuit):
    ...
    def generate(self, subcircuit_filename, min_tran_width):
        ...
        self.transistor_names, self.wire_names = dummyarray_subcircuits.generate_precharge_dummy_lp(subcircuit_filename, self.name)
        self.initial_transistor_sizes["ptran_precharge_dummy"] = 2
        self.initial_transistor_sizes["ptran_equalization_dummy"] = 1
    ...
    def update_area(self, area_dict, width_dict):
        ...
        area = area_dict["ptran_precharge_dummy"]*2 + area_dict["ptran_equalization_dummy"]
        area_with_sram = area
        width = math.sqrt(area)
        width_with_sram = math.sqrt(area_with_sram)
        area_dict[self.name] = area
...
class _RAM(_CompoundCircuit):
    ...
    def __init__(self, row_decoder_bits, col_decoder_bits, conf_decoder_bits, RAM_local_mux_size_required, RAM_num_local_mux_per_tile, use_tgate ,sram_area, number_of_banks, memory_technology, cspecs, process_data_filename, read_to_write_ratio):
        ...
        if self.memory_technology == "SRAM":
            ...
            self.samp = _samp(self.use_tgate, 2**self.row_decoder_bits, 0, self.cspecs.sense_dv)
    ...
    def generate_top(self):
        ...
        self.manchester4_dummy.generate_top()    # remove later             
...
class FPGA:
    ...
    def update_area(self):
        ...
        if self.specs.enable_bram_block == 1:
            ...
            self.area_dict["ram_core"] = RAM_area - RAM_SB_area - RAM_CB_area - RAM_dummy_area
    ...
    def update_delays(self, spice_interface):
        ...
        if self.RAM.memory_technology == "SRAM":
            ...
            if self.specs.enable_cim == 1:
                print "  Updating delay for " + self.RAM.precharge_dummy.name
                spice_meas = spice_interface.run(self.RAM.precharge_dummy.top_spice_path, parameter_dict) 
                if spice_meas["meas_total_tfall"][0] == "failed" or spice_meas["meas_total_trise"][0] == "failed" :
                    valid_delay = False
                    tfall = 1
                    trise = 1
                ...
                if tfall < 0 or trise < 0 :
                    valid_delay = False
                self.RAM.precharge_dummy.tfall = tfall
                self.RAM.precharge_dummy.trise = trise
                self.RAM.precharge_dummy.delay = max(tfall, trise)
                ...
                if tfall < 0 or trise < 0 :
                    valid_delay = False
                self.RAM.writedriver_dummy.tfall = tfall
                self.RAM.writedriver_dummy.trise = trise
                self.RAM.writedriver_dummy.delay = max(tfall, trise)
                self.delay_dict[self.RAM.writedriver_dummy.name] = self.RAM.writedriver_dummy.delay
                self.RAM.writedriver_dummy.power = float(spice_meas["meas_avg_power"][0])

                print "  Updating delay for " + self.RAM.samp_dummy.name
                spice_meas = spice_interface.run(self.RAM.samp_dummy.top_spice_path, parameter_dict) 
                if spice_meas["meas_total_tfall"][0] == "failed" or spice_meas["meas_total_trise"][0] == "failed" :
                    valid_delay = False
                    tfall = 1
                    trise = 1
                ...
                if tfall < 0 or trise < 0 :
                    valid_delay = False
                self.RAM.fulladder_dummy.tfall = tfall
                self.RAM.fulladder_dummy.trise = trise
                self.RAM.fulladder_dummy.delay = max(tfall, trise)
                self.delay_dict[self.RAM.fulladder_dummy.name] = self.RAM.fulladder_dummy.delay
                self.RAM.fulladder_dummy.power = float(spice_meas["meas_avg_power"][0])

                print "  Updating delay for " + self.RAM.manchester4_dummy.name
                spice_meas = spice_interface.run(self.RAM.manchester4_dummy.top_spice_path, parameter_dict) 
                if spice_meas["meas_total_tfall"][0] == "failed" or spice_meas["meas_total_trise"][0] == "failed" :
                    valid_delay = False
                    tfall = 1
                    trise = 1
                ...
                if tfall < 0 or trise < 0 :
                    valid_delay = False
                self.RAM.manchester4_dummy.tfall = tfall
                self.RAM.manchester4_dummy.trise = trise
                self.RAM.manchester4_dummy.delay = max(tfall, trise)
                ...
                if tfall < 0 or trise < 0 :
                    valid_delay = False
                self.RAM.lookahead4_dummy.tfall = tfall
                self.RAM.lookahead4_dummy.trise = trise
                ...
                if tfall < 0 or trise < 0 :
                    valid_delay = False
                self.RAM.mux3_dummy.tfall = tfall
                self.RAM.mux3_dummy.trise = trise
                self.RAM.mux3_dummy.delay = max(tfall, trise)
                self.delay_dict[self.RAM.mux3_dummy.name] = self.RAM.mux3_dummy.delay
                self.RAM.mux3_dummy.power = float(spice_meas["meas_avg_power"][0])
                
                print "  Updating delay for " + self.RAM.mux2_dummy.name
                spice_meas = spice_interface.run(self.RAM.mux2_dummy.top_spice_path, parameter_dict) 
                if spice_meas["meas_total_tfall"][0] == "failed" or spice_meas["meas_total_trise"][0] == "failed" :
                    valid_delay = False
                    tfall = 1
                    trise = 1
                ...
                if tfall < 0 or trise < 0 :
                    valid_delay = False
                self.RAM.mux2_dummy.tfall = tfall
                self.RAM.mux2_dummy.trise = trise
                self.RAM.mux2_dummy.delay = max(tfall, trise)
                self.delay_dict[self.RAM.mux2_dummy.name] = self.RAM.mux2_dummy.delay
                self.RAM.mux2_dummy.power = float(spice_meas["meas_avg_power"][0])
        else:
    ...
    def _generate_basic_subcircuits(self):
        ...
        basic_subcircuits.nand2_dummy_generate(self.basic_subcircuits_filename, self.specs.use_finfet)
        basic_subcircuits.nand2_dummy_generate_lp(self.basic_subcircuits_filename, self.specs.use_finfet)
        basic_subcircuits.nor2_dummy_generate(self.basic_subcircuits_filename, self.specs.use_finfet)
        basic_subcircuits.nor2_dummy_generate_lp(self.basic_subcircuits_filename, self.specs.use_finfet)
        # Generate nand3 
